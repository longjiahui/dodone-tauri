...
declare global {
  ...
  const TooltipComponentOption: typeof import('echarts/components').TooltipComponentOption
  const TransformComponent: typeof import('echarts/components').TransformComponent
  const TransformComponentOption: typeof import('echarts/components').TransformComponentOption
  ...
  const graphic: typeof import('echarts').graphic
